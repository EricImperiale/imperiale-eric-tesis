...
class EditRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'dni' => 'required|digits:8|unique:owners,dni,' . $ownerId,
            'cuit' => [
                'required',
                'digits:11',
                'unique:owners,cuit,' . $ownerId,
    ...
    public function messages()
    {
        return [
            ...
            'dni.unique' => 'Este DNI ya está registrado en otro propietario.',
            'cuit.required' => 'El CUIT es obligatorio.',
            'cuit.digits' => 'El CUIT debe tener 11 dígitos.',
            'cuit.unique' => 'Este CUIT ya está registrado en otro propietario.',
            'email.required' => 'El correo electrónico es obligatorio.',
            'email.email' => 'El correo electrónico debe ser válido.',
            'email.unique' => 'Este correo electrónico ya está registrado en otro propietario.',
