...
<x-app-layout title="Tus Propietarios">
    <div class="container mx-auto">
        ...
        @if($owners->isNotEmpty() || $baseSearches->getFullName())
            <x-base-filter
                route="owners.index"
                name="fn"
        ...
        @if($owners->isEmpty() && $baseSearches->getFullName())
            <p class="text-gray-700">No se encontraron propietarios con el filtro aplicado <b>{{ $baseSearches->getFullName() }}</b>.</p>
        ...
        @else
            ...
            <div class="overflow-x-auto">
                <x-table :info="$owners" model="owners">
                    <thead>
                    <tr>
